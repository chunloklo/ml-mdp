...
# np.save("data/{}-small-q-softmax-1.npy".format(timestr), q)
# np.save("data/{}-small-q_start_hist-softmax-1.npy".format(timestr), q_start_hist)
# np.save("data/{}-small-total_reward_hist-softmax-1.npy".format(timestr), total_reward_hist)
# plt.show()
