...
p = 0.1
qlearn = QLearn(num_states=32 * 32, num_actions=4, alpha=0.1, gamma=0.99, epsilon=0.1)
...
qlearn = QLearn(num_states=32 * 32, num_actions=4, alpha=0.05, gamma=0.99, epsilon=0.1)
...
qlearn = QLearn(num_states=32 * 32, num_actions=4, alpha=0.2, gamma=0.99, epsilon=0.1)
...
np.save("data/{}-large-q-a-p1.npy".format(timestr), q1)
np.save("data/{}-large-q_start_hist-a-p1.npy".format(timestr), q_start_hist1)
np.save("data/{}-large-total_reward_hist-a-p1.npy".format(timestr), total_reward_hist1)

np.save("data/{}-large-q-a-p05.npy".format(timestr), q2)
np.save("data/{}-large-q_start_hist-a-p05.npy".format(timestr), q_start_hist2)
np.save("data/{}-large-total_reward_hist-a-p05.npy".format(timestr), total_reward_hist2)

np.save("data/{}-large-q-a-p2.npy".format(timestr), q3)
np.save("data/{}-large-q_start_hist-a-p2.npy".format(timestr), q_start_hist3)
np.save("data/{}-large-total_reward_hist-a-p2.npy".format(timestr), total_reward_hist3)
