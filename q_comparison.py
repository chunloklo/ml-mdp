...
qlearn = QLearn(num_states=16 * 16, num_actions=4, alpha=0.05, gamma=0.9, epsilon=0.1)
...
qlearn = QLearn(num_states=16 * 16, num_actions=4, alpha=0.2, gamma=0.9, epsilon=0.1)
...
np.save("data/{}-0p1-small-q-a-p1.npy".format(timestr), q1)
np.save("data/{}-0p1-small-q_start_hist-a-p1.npy".format(timestr), q_start_hist1)
np.save("data/{}-0p1-small-total_reward_hist-a-p1.npy".format(timestr), total_reward_hist1)

np.save("data/{}-0p1-small-q-a-p05.npy".format(timestr), q2)
np.save("data/{}-0p1-small-q_start_hist-a-p05.npy".format(timestr), q_start_hist2)
np.save("data/{}-0p1-small-total_reward_hist-a-p05.npy".format(timestr), total_reward_hist2)

np.save("data/{}-0p1-small-q-a-p2.npy".format(timestr), q3)
np.save("data/{}-0p1-small-q_start_hist-a-p2.npy".format(timestr), q_start_hist3)
np.save("data/{}-0p1-small-total_reward_hist-a-p2.npy".format(timestr), total_reward_hist3)
