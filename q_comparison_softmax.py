...
p = 0.1
qlearn = QLearn(num_states=16 * 16, num_actions=4, alpha=0.1, gamma=0.9, epsilon=0.1, softmax=True)
...
np.save("data/{}-small-q-softmax-100.npy".format(timestr), q)
np.save("data/{}-small-q_start_hist-softmax-100.npy".format(timestr), q_start_hist)
np.save("data/{}-small-total_reward_hist-softmax-100.npy".format(timestr), total_reward_hist)
plt.show()


qlearn = QLearn(num_states=16 * 16, num_actions=4, alpha=0.1, gamma=0.9, epsilon=0.05)
...
for e in range(episodes):
    ...
    while not done:
        ...
        qlearn.learn(obs, action, reward, new_obs)
        # if (action == 1):
        # print(obs, action, reward, new_obs)
        # env.render()
        # time.sleep(0.01)
...
qlearn = QLearn(num_states=16 * 16, num_actions=4, alpha=0.1, gamma=0.9, epsilon=0.2)
...
np.save("data/{}-0p1-small-q-epsilon-p1.npy".format(timestr), q1)
np.save("data/{}-0p1-small-q_start_hist-epsilon-p1.npy".format(timestr), q_start_hist1)
np.save("data/{}-0p1-small-total_reward_hist-epsilon-p1.npy".format(timestr), total_reward_hist1)

np.save("data/{}-0p1-small-q-epsilon-p05.npy".format(timestr), q2)
np.save("data/{}-0p1-small-q_start_hist-epsilon-p05.npy".format(timestr), q_start_hist2)
np.save("data/{}-0p1-small-total_reward_hist-epsilon-p05.npy".format(timestr), total_reward_hist2)

np.save("data/{}-0p1-small-q-epsilon-p2.npy".format(timestr), q3)
np.save("data/{}-0p1-small-q_start_hist-epsilon-p2.npy".format(timestr), q_start_hist3)
np.save("data/{}-0p1-small-total_reward_hist-epsilon-p2.npy".format(timestr), total_reward_hist3)
