...
# plt.show()
np.save("data/{}-0p3-small-q-epsilon-p1.npy".format(timestr), q1)
np.save("data/{}-0p5-small-q-epsilon-p1.npy".format(timestr), q2)
np.save("data/{}-0p1-small-q-epsilon-p1.npy".format(timestr), q3)
